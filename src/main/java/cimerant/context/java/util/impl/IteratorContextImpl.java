...
public class IteratorContextImpl<E extends Iterator<?>, T extends ContextRoot<?>>
  ...
  static {
    logger = (CimerantLogger) LoggerFactory.getLogger(IteratorContextImpl.class.getName());
  }
  ...
  public static final <E extends Iterator<?>, T extends ContextRoot<?>>
    ...
    try {
      ...
      // 0001 | Unknown error
      if (IteratorContextImpl.logger.isDebugEnabled()) {
        IteratorContextImpl.logger.debug(t.getMessage(), t);
      }
