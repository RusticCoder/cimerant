...
public final class MapEntryListIteratorContextImpl<K, V>
  ...
  public static <K, V> MapEntryListIteratorContext<K, V> getInstance(
    ...
    final var moduleCode = ModuleCode.ERR_M1900;
    ...
    try {
      ...
      // 0001 | Unknown error
      if (MapEntryListIteratorContextImpl.logger.isDebugEnabled()) {
        MapEntryListIteratorContextImpl.logger.debug(t.getMessage(), t);
      }
