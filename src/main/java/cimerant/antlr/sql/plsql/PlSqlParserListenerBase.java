 ...
 */
public class PlSqlParserListenerBase extends PlSqlParserBaseListener {
  private static final CimerantLogger logger;

  static {
    logger = CimerantLogger.getLogger(PlSqlParserListenerBase.class.getName());
  }

  private static void traceChildren(final String methodName, final ParseTree ctx) {
    if (PlSqlParserListenerBase.logger.isTraceEnabled()) {
  ...
  public void enterAccess_driver_type(final PlSqlParser.Access_driver_typeContext ctx) {
    ...
    PlSqlParserListenerBase.traceChildren(methodName, ctx);
  }
  ...
  public void visitErrorNode(final ErrorNode node) {
    ...
    PlSqlParserListenerBase.traceChildren(methodName, node);
  }
