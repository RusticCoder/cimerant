...
public interface PlSqlParserVisitor<T> extends ParseTreeVisitor<T> {
   ...
   * @return the visitor result
   */
  T visitZero_downtime_software_patching_clauses(
   ...
   * @return the visitor result
   */
  T visitBlockchain_hash_and_data_format_clause(
   ...
   * @return the visitor result
   */
  T visitAutogenerated_sequence_definition(
   ...
   * @return the visitor result
   */
  T visitData_manipulation_language_statements(
  ...
  /**
   * Visit a parse tree produced by the {@code table_ref_aux_internal_one} labeled alternative in
  ...
  /**
   * Visit a parse tree produced by the {@code table_ref_aux_internal_two} labeled alternative in
   * {@link PlSqlParser#table_ref_aux_internal}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code table_ref_aux_internal_thre} labeled alternative in
   * {@link PlSqlParser#table_ref_aux_internal}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   ...
   * @return the visitor result
   */
  T visitStandard_prediction_function_keyword(
   ...
   * @return the visitor result
   */
  T visitXmlserialize_param_enconding_part(
