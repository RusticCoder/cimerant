...
public interface SnowflakeParserVisitor<T> extends ParseTreeVisitor<T> {
   ...
   * @return the visitor result
   */
  T visitAlter_security_integration_external_oauth(
   ...
   * @return the visitor result
   */
  T visitSecurity_integration_external_oauth_property(
   ...
   * @return the visitor result
   */
  T visitAlter_security_integration_snowflake_oauth(
   ...
   * @return the visitor result
   */
  T visitSecurity_integration_snowflake_oauth_property(
   ...
   * @return the visitor result
   */
  T visitAlter_security_integration_saml2(
   ...
   * @return the visitor result
   */
  T visitAlter_security_integration_scim(
   ...
   * @return the visitor result
   */
  T visitSecurity_integration_scim_property(
   ...
   * @return the visitor result
   */
  T visitInitially_deferred_or_immediate(
   ...
   * @return the visitor result
   */
  T visitExternal_table_column_decl_list(
   ...
   * @return the visitor result
   */
  T visitCreate_notification_integration(
   ...
   * @return the visitor result
   */
  T visitCreate_security_integration_external_oauth(
   ...
   * @return the visitor result
   */
  T visitCreate_security_integration_snowflake_oauth(
   ...
   * @return the visitor result
   */
  T visitCreate_security_integration_saml2(
   ...
   * @return the visitor result
   */
  T visitCreate_security_integration_scim(
   ...
   * @return the visitor result
   */
  T visitAz_credential_or_storage_integration(
   ...
   * @return the visitor result
   */
  T visitAws_credential_or_storage_integration(
   ...
   * @return the visitor result
   */
  T visitDirectory_table_internal_params(
   ...
   * @return the visitor result
   */
  T visitDirectory_table_external_params(
   ...
   * @return the visitor result
   */
  T visitTask_suspend_after_failure_number(
   ...
   * @return the visitor result
   */
  T visitShow_databases_in_failover_group(
   ...
   * @return the visitor result
   */
  T visitShow_databases_in_replication_group(
   ...
   * @return the visitor result
   */
  T visitShow_shares_in_replication_group(
   ...
   * @return the visitor result
   */
  T visitUnary_or_binary_builtin_function(
   ...
   * @return the visitor result
   */
  T visitBinary_or_ternary_builtin_function(
   ...
   * @return the visitor result
   */
  T visitSwitch_search_condition_section(
