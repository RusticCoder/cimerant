...
public interface MySqlParserVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code alterByAlterCheckTableConstraint} labeled alternative
   * in {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code alterByAlterColumnDefault} labeled alternative in
   * {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code randomAuthOption} labeled alternative in {@link
   * MySqlParser#userAuthOption}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code showLogEvents} labeled alternative in {@link
   * MySqlParser#showStatement}.
   *
   * @param ctx the parse tree
   * @return the visitor result
