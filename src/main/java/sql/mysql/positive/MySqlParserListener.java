// Generated from sql/mysql/positive/MySqlParser.g4 by ANTLR 4.13.1

package sql.mysql.positive;
...
public interface MySqlParserListener extends ParseTreeListener {
   ...
   * MySqlParser#scheduleExpression}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#columnConstraint}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#tableConstraint}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#indexColumnDefinition}.
   *
   * @param ctx the parse tree
   */
   ...
   * in {@link MySqlParser#tableOption}.
   *
   * @param ctx the parse tree
   */
   ...
   * alternative in {@link MySqlParser#tableOption}.
   *
   * @param ctx the parse tree
   */
  void enterTableOptionSecondaryEngineAttribute(
      MySqlParser.TableOptionSecondaryEngineAttributeContext ctx);
   ...
   * {@link MySqlParser#subpartitionFunctionDefinition}.
   *
   * @param ctx the parse tree
   */
   ...
   * MySqlParser#subpartitionFunctionDefinition}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#partitionOption}.
   *
   * @param ctx the parse tree
   */
   ...
   * MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
   ...
   * in {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code alterByAlterCheckTableConstraint} labeled alternative
   * in {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
  void enterAlterByAlterCheckTableConstraint(
      MySqlParser.AlterByAlterCheckTableConstraintContext ctx);

  /**
   * Exit a parse tree produced by the {@code alterByAlterCheckTableConstraint} labeled alternative
   * in {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
  void exitAlterByAlterCheckTableConstraint(
      MySqlParser.AlterByAlterCheckTableConstraintContext ctx);
  ...
  /**
   * Enter a parse tree produced by the {@code alterByAlterColumnDefault} labeled alternative in
   * {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code alterByAlterColumnDefault} labeled alternative in
   * {@link MySqlParser#alterSpecification}.
   *
   * @param ctx the parse tree
   */
   ...
   * MySqlParser#alterPartitionSpecification}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#alterPartitionSpecification}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#selectElement}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#replicationFilter}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#connectionOption}.
   *
   * @param ctx the parse tree
   */
   ...
   * MySqlParser#handlerConditionValue}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#handlerConditionValue}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code randomAuthOption} labeled alternative in {@link
   * MySqlParser#userAuthOption}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code randomAuthOption} labeled alternative in {@link
   * MySqlParser#userAuthOption}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#privilegeLevel}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code showLogEvents} labeled alternative in {@link
   * MySqlParser#showStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code showLogEvents} labeled alternative in {@link
   * MySqlParser#showStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  void enterDiagnosticsConditionInformationName(
      MySqlParser.DiagnosticsConditionInformationNameContext ctx);
   ...
   * MySqlParser#describeObjectClause}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link MySqlParser#specificFunction}.
   *
   * @param ctx the parse tree
   */
