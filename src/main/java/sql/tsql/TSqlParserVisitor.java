...
public interface TSqlParserVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code RANKING_WINDOWED_FUNC} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code ANALYTIC_WINDOWED_FUNC} labeled alternative in {@link
   * TSqlParser#function_call}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code CURRENT_TRANSACTION_ID} labeled alternative in {@link
   * TSqlParser#built_in_functions}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code MIN_ACTIVE_ROWVERSION} labeled alternative in {@link
   * TSqlParser#built_in_functions}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code SMALLDATETIMEFROMPARTS} labeled alternative in {@link
   * TSqlParser#built_in_functions}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code DATABASE_PRINCIPAL_ID} labeled alternative in {@link
   * TSqlParser#built_in_functions}.
   *
   * @param ctx the parse tree
   * @return the visitor result
