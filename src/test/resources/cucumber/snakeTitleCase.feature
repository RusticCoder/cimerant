Feature: Snake Title Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to snake title case.
  @snakeTitleCaseTemplate
  Scenario Outline: Template
    Given snakeTitleCaseTemplate.<pUnique> input file <pInputFile>
    * snakeTitleCaseTemplate.<pUnique> template <pTemplate>
    * snakeTitleCaseTemplate.<pUnique> templates <pTemplates>
    * snakeTitleCaseTemplate.<pUnique> single multi value <pSinti>
    * snakeTitleCaseTemplate.<pUnique> path <pPath>
    * snakeTitleCaseTemplate.<pUnique> file <pFile>
    * snakeTitleCaseTemplate.<pUnique> var <pVar>
    * snakeTitleCaseTemplate.<pUnique> vars <pVars>
    When snakeTitleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then snakeTitleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to snake title case.
  @snakeTitleCaseValue
  Scenario Outline: Value
    Given snakeTitleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then snakeTitleCaseValue.<pUnique> Cimerant outputs <pOutputString>
