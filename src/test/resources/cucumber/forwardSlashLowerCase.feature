Feature: Forward Slash Lower Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to forward slash lower case.
  @forwardSlashLowerCaseTemplate
  Scenario Outline: Template
    Given forwardSlashLowerCaseTemplate.<pUnique> input file <pInputFile>
    * forwardSlashLowerCaseTemplate.<pUnique> template <pTemplate>
    * forwardSlashLowerCaseTemplate.<pUnique> templates <pTemplates>
    * forwardSlashLowerCaseTemplate.<pUnique> single multi value <pSinti>
    * forwardSlashLowerCaseTemplate.<pUnique> path <pPath>
    * forwardSlashLowerCaseTemplate.<pUnique> file <pFile>
    * forwardSlashLowerCaseTemplate.<pUnique> var <pVar>
    * forwardSlashLowerCaseTemplate.<pUnique> vars <pVars>
    When forwardSlashLowerCaseTemplate.<pUnique> the values are passed into Cimerant
    Then forwardSlashLowerCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to forward slash lower case.
  @forwardSlashLowerCaseValue
  Scenario Outline: Value
    Given forwardSlashLowerCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then forwardSlashLowerCaseValue.<pUnique> Cimerant outputs <pOutputString>
