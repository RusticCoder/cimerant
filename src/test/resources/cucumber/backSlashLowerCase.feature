Feature: Back Slash Lower Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to back slash lower case.
  @backSlashLowerCaseTemplate
  Scenario Outline: Template
    Given backSlashLowerCaseTemplate.<pUnique> input file <pInputFile>
    * backSlashLowerCaseTemplate.<pUnique> template <pTemplate>
    * backSlashLowerCaseTemplate.<pUnique> templates <pTemplates>
    * backSlashLowerCaseTemplate.<pUnique> single multi value <pSinti>
    * backSlashLowerCaseTemplate.<pUnique> path <pPath>
    * backSlashLowerCaseTemplate.<pUnique> file <pFile>
    * backSlashLowerCaseTemplate.<pUnique> var <pVar>
    * backSlashLowerCaseTemplate.<pUnique> vars <pVars>
    When backSlashLowerCaseTemplate.<pUnique> the values are passed into Cimerant
    Then backSlashLowerCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to back slash lower case.
  @backSlashLowerCaseValue
  Scenario Outline: Value
    Given backSlashLowerCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then backSlashLowerCaseValue.<pUnique> Cimerant outputs <pOutputString>

    Examples:
      | pUnique | pInputString      | pOutputString     |
      | 1       | null              | ""                |
      | 2       | ""                | ""                |
      | 3       | "a test string"   | "a\\test\\string" |
      | 4       | "a Test String"   | "a\\test\\string" |
      | 5       | "A test string"   | "a\\test\\string" |
      | 6       | "A Test String"   | "a\\test\\string" |
      | 7       | "A TEST STRING"   | "a\\test\\string" |
      | 8       | "a_test_string"   | "a\\test\\string" |
      | 9       | "a_Test_String"   | "a\\test\\string" |
      | 10      | "A_test_string"   | "a\\test\\string" |
      | 11      | "A_Test_String"   | "a\\test\\string" |
      | 12      | "A_TEST_STRING"   | "a\\test\\string" |
      | 13      | "a-test-string"   | "a\\test\\string" |
      | 14      | "a-Test-String"   | "a\\test\\string" |
      | 15      | "A-test-string"   | "a\\test\\string" |
      | 16      | "A-Test-String"   | "a\\test\\string" |
      | 17      | "A-TEST-STRING"   | "a\\test\\string" |
      | 18      | "a.test.string"   | "a\\test\\string" |
      | 19      | "a.Test.String"   | "a\\test\\string" |
      | 20      | "A.test.string"   | "a\\test\\string" |
      | 21      | "A.Test.String"   | "a\\test\\string" |
      | 22      | "A.TEST.STRING"   | "a\\test\\string" |
      | 23      | "a_test_string"   | "a\\test\\string" |
      | 24      | "a_Test_String"   | "a\\test\\string" |
      | 25      | "A_test_string"   | "a\\test\\string" |
      | 26      | "A_Test_String"   | "a\\test\\string" |
      | 27      | "A_TEST_STRING"   | "a\\test\\string" |
      | 28      | "a/test/string"   | "a\\test\\string" |
      | 29      | "a/Test/String"   | "a\\test\\string" |
      | 30      | "A/test/string"   | "a\\test\\string" |
      | 31      | "A/Test/String"   | "a\\test\\string" |
      | 32      | "A/TEST/STRING"   | "a\\test\\string" |
      | 33      | "a\\test\\string" | "a\\test\\string" |
      | 34      | "a\\Test\\String" | "a\\test\\string" |
      | 35      | "A\\test\\string" | "a\\test\\string" |
      | 36      | "A\\Test\\String" | "a\\test\\string" |
      | 37      | "A\\TEST\\STRING" | "a\\test\\string" |
      ...
      | 43      | "aTestString"     | "a\\test\\string" |
      | 44      | "ATestString"     | "a\\test\\string" |
