Feature: Kebab Title Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to kebab title case.
  @kebabTitleCaseTemplate
  Scenario Outline: Template
    Given kebabTitleCaseTemplate.<pUnique> input file <pInputFile>
    * kebabTitleCaseTemplate.<pUnique> template <pTemplate>
    * kebabTitleCaseTemplate.<pUnique> templates <pTemplates>
    * kebabTitleCaseTemplate.<pUnique> single multi value <pSinti>
    * kebabTitleCaseTemplate.<pUnique> path <pPath>
    * kebabTitleCaseTemplate.<pUnique> file <pFile>
    * kebabTitleCaseTemplate.<pUnique> var <pVar>
    * kebabTitleCaseTemplate.<pUnique> vars <pVars>
    When kebabTitleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then kebabTitleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to kebab title case.
  @kebabTitleCaseValue
  Scenario Outline: Value
    Given kebabTitleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then kebabTitleCaseValue.<pUnique> Cimerant outputs <pOutputString>
