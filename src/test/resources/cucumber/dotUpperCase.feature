Feature: Dot Upper Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to dot upper case.
  @dotUpperCaseTemplate
  Scenario Outline: Template
    Given dotUpperCaseTemplate.<pUnique> input file <pInputFile>
    * dotUpperCaseTemplate.<pUnique> template <pTemplate>
    * dotUpperCaseTemplate.<pUnique> templates <pTemplates>
    * dotUpperCaseTemplate.<pUnique> single multi value <pSinti>
    * dotUpperCaseTemplate.<pUnique> path <pPath>
    * dotUpperCaseTemplate.<pUnique> file <pFile>
    * dotUpperCaseTemplate.<pUnique> var <pVar>
    * dotUpperCaseTemplate.<pUnique> vars <pVars>
    When dotUpperCaseTemplate.<pUnique> the values are passed into Cimerant
    Then dotUpperCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to dot upper case.
  @dotUpperCaseValue
  Scenario Outline: Value
    Given dotUpperCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then dotUpperCaseValue.<pUnique> Cimerant outputs <pOutputString>
