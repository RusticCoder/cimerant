Feature: Title Case
  ...
  # The user will be able to combine a Velocity template and a formatted file to transform the values to title case.
  @titleCaseTemplate
  Scenario Outline: Template
    Given titleCaseTemplate.<pUnique> input file <pInputFile>
    * titleCaseTemplate.<pUnique> template <pTemplate>
    * titleCaseTemplate.<pUnique> templates <pTemplates>
    * titleCaseTemplate.<pUnique> single multi value <pSinti>
    * titleCaseTemplate.<pUnique> path <pPath>
    * titleCaseTemplate.<pUnique> file <pFile>
    * titleCaseTemplate.<pUnique> var <pVar>
    * titleCaseTemplate.<pUnique> vars <pVars>
    When titleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then titleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to title case.
  @titleCaseValue
  Scenario Outline: Value
    Given titleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then titleCaseValue.<pUnique> Cimerant outputs <pOutputString>
