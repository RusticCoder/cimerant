Feature: Kebab Lower Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to kebab lower case.
  @kebabLowerCaseTemplate
  Scenario Outline: Template
    Given kebabLowerCaseTemplate.<pUnique> input file <pInputFile>
    * kebabLowerCaseTemplate.<pUnique> template <pTemplate>
    * kebabLowerCaseTemplate.<pUnique> templates <pTemplates>
    * kebabLowerCaseTemplate.<pUnique> single multi value <pSinti>
    * kebabLowerCaseTemplate.<pUnique> path <pPath>
    * kebabLowerCaseTemplate.<pUnique> file <pFile>
    * kebabLowerCaseTemplate.<pUnique> var <pVar>
    * kebabLowerCaseTemplate.<pUnique> vars <pVars>
    When kebabLowerCaseTemplate.<pUnique> the values are passed into Cimerant
    Then kebabLowerCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to kebab lower case.
  @kebabLowerCaseValue
  Scenario Outline: Value
    Given kebabLowerCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then kebabLowerCaseValue.<pUnique> Cimerant outputs <pOutputString>
