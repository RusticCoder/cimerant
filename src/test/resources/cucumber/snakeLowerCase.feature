Feature: Snake Lower Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to snake lower case.
  @snakeLowerCaseTemplate
  Scenario Outline: Template
    Given snakeLowerCaseTemplate.<pUnique> input file <pInputFile>
    * snakeLowerCaseTemplate.<pUnique> template <pTemplate>
    * snakeLowerCaseTemplate.<pUnique> templates <pTemplates>
    * snakeLowerCaseTemplate.<pUnique> single multi value <pSinti>
    * snakeLowerCaseTemplate.<pUnique> path <pPath>
    * snakeLowerCaseTemplate.<pUnique> file <pFile>
    * snakeLowerCaseTemplate.<pUnique> var <pVar>
    * snakeLowerCaseTemplate.<pUnique> vars <pVars>
    When snakeLowerCaseTemplate.<pUnique> the values are passed into Cimerant
    Then snakeLowerCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to snake lower case.
  @snakeLowerCaseValue
  Scenario Outline: Value
    Given snakeLowerCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then snakeLowerCaseValue.<pUnique> Cimerant outputs <pOutputString>
