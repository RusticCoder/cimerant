Feature: Forward Slash Upper Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to forward slash upper case.
  @forwardSlashUpperCaseTemplate
  Scenario Outline: Template
    Given forwardSlashUpperCaseTemplate.<pUnique> input file <pInputFile>
    * forwardSlashUpperCaseTemplate.<pUnique> template <pTemplate>
    * forwardSlashUpperCaseTemplate.<pUnique> templates <pTemplates>
    * forwardSlashUpperCaseTemplate.<pUnique> single multi value <pSinti>
    * forwardSlashUpperCaseTemplate.<pUnique> path <pPath>
    * forwardSlashUpperCaseTemplate.<pUnique> file <pFile>
    * forwardSlashUpperCaseTemplate.<pUnique> var <pVar>
    * forwardSlashUpperCaseTemplate.<pUnique> vars <pVars>
    When forwardSlashUpperCaseTemplate.<pUnique> the values are passed into Cimerant
    Then forwardSlashUpperCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to forward slash upper case.
  @forwardSlashUpperCaseValue
  Scenario Outline: Value
    Given forwardSlashUpperCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then forwardSlashUpperCaseValue.<pUnique> Cimerant outputs <pOutputString>
    ...
    Examples:
      ...
      | 8       | "a_test_string"   | "A/TEST/STRING" |
      | 9       | "a_Test_String"   | "A/TEST/STRING" |
      | 10      | "A_test_string"   | "A/TEST/STRING" |
      | 11      | "A_Test_String"   | "A/TEST/STRING" |
      | 12      | "A_TEST_STRING"   | "A/TEST/STRING" |
      ...
      | 23      | "a_test_string"   | "A/TEST/STRING" |
      | 24      | "a_Test_String"   | "A/TEST/STRING" |
      | 25      | "A_test_string"   | "A/TEST/STRING" |
      | 26      | "A_Test_String"   | "A/TEST/STRING" |
      | 27      | "A_TEST_STRING"   | "A/TEST/STRING" |
      ...
      | 33      | "a\\test\\string" | "A/TEST/STRING" |
      | 34      | "a\\Test\\String" | "A/TEST/STRING" |
      | 35      | "A\\test\\string" | "A/TEST/STRING" |
      ...
      | 43      | "aTestString"     | "A/TEST/STRING" |
      | 44      | "ATestString"     | "A/TEST/STRING" |
