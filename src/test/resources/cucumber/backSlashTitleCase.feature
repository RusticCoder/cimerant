Feature: Back Slash Title Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to back slash title case.
  @backSlashTitleCaseTemplate
  Scenario Outline: Template
    Given backSlashTitleCaseTemplate.<pUnique> input file <pInputFile>
    * backSlashTitleCaseTemplate.<pUnique> template <pTemplate>
    * backSlashTitleCaseTemplate.<pUnique> templates <pTemplates>
    * backSlashTitleCaseTemplate.<pUnique> single multi value <pSinti>
    * backSlashTitleCaseTemplate.<pUnique> path <pPath>
    * backSlashTitleCaseTemplate.<pUnique> file <pFile>
    * backSlashTitleCaseTemplate.<pUnique> var <pVar>
    * backSlashTitleCaseTemplate.<pUnique> vars <pVars>
    When backSlashTitleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then backSlashTitleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to back slash title case.
  @backSlashTitleCaseValue
  Scenario Outline: Value
    Given backSlashTitleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then backSlashTitleCaseValue.<pUnique> Cimerant outputs <pOutputString>
