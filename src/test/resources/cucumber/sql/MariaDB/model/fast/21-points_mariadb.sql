...
--
-- Host: localhost    Database: healthpoints
-- ------------------------------------------------------
...
CREATE TABLE `blood_pressure` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_blood_pressure__user_id` (`user_id`),
  CONSTRAINT `fk_blood_pressure__user_id` FOREIGN KEY (`user_id`) REFERENCES `jhi_user` (`id`)
...
CREATE TABLE `points` (
  ...
  `user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_points__user_id` (`user_id`),
  CONSTRAINT `fk_points__user_id` FOREIGN KEY (`user_id`) REFERENCES `jhi_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `preferences` (
  ...
  `user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_preferences__user_id` (`user_id`),
  CONSTRAINT `fk_preferences__user_id` FOREIGN KEY (`user_id`) REFERENCES `jhi_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weight` (
  ...
  `user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_weight__user_id` (`user_id`),
  CONSTRAINT `fk_weight__user_id` FOREIGN KEY (`user_id`) REFERENCES `jhi_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-03 15:40:29
