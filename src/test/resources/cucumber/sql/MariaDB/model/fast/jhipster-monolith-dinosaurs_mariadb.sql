...
--
-- Host: localhost    Database: dinosaurs
-- ------------------------------------------------------
...
CREATE TABLE `dinosaur` (
  ...
  `insert_dt` datetime(6) NOT NULL,
  `modified_dt` datetime(6) NOT NULL,
  `era_id` bigint(20) DEFAULT NULL,
  `clade_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_dinosaur__era_id` (`era_id`),
  KEY `fk_dinosaur__clade_id` (`clade_id`),
  CONSTRAINT `fk_dinosaur__clade_id` FOREIGN KEY (`clade_id`) REFERENCES `clade` (`id`),
  CONSTRAINT `fk_dinosaur__era_id` FOREIGN KEY (`era_id`) REFERENCES `era` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `era` (
  `id` bigint(20) NOT NULL,
  `name` varchar(64) NOT NULL,
  `from_ma` int(11) DEFAULT NULL,
  `to_ma` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-03 20:51:43
