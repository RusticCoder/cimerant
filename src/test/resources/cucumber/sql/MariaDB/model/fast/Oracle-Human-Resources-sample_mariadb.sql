...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='The Employee entity.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='not an ignored comment';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task` (
  ...
  `description` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='Task entity.\\n@author The JHipster team.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-03 22:47:47
