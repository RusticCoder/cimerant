...
--
-- Table structure for table `space_event`
--

DROP TABLE IF EXISTS `space_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `space_event` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_space_event__mission_id` (`mission_id`),
  CONSTRAINT `fk_space_event__mission_id` FOREIGN KEY (`mission_id`) REFERENCES `mission` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1500 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-03 23:04:21
