Feature: Dot Title Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to dot title case.
  @dotTitleCaseTemplate
  Scenario Outline: Template
    Given dotTitleCaseTemplate.<pUnique> input file <pInputFile>
    * dotTitleCaseTemplate.<pUnique> template <pTemplate>
    * dotTitleCaseTemplate.<pUnique> templates <pTemplates>
    * dotTitleCaseTemplate.<pUnique> single multi value <pSinti>
    * dotTitleCaseTemplate.<pUnique> path <pPath>
    * dotTitleCaseTemplate.<pUnique> file <pFile>
    * dotTitleCaseTemplate.<pUnique> var <pVar>
    * dotTitleCaseTemplate.<pUnique> vars <pVars>
    When dotTitleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then dotTitleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to dot title case.
  @dotTitleCaseValue
  Scenario Outline: Value
    Given dotTitleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then dotTitleCaseValue.<pUnique> Cimerant outputs <pOutputString>
