Feature: Lower Case
  ...
  # The user will be able to combine a Velocity template and a formatted file to transform the values to lower case.
  @lowerCaseTemplate
  Scenario Outline: Template
    Given lowerCaseTemplate.<pUnique> input file <pInputFile>
    * lowerCaseTemplate.<pUnique> template <pTemplate>
    * lowerCaseTemplate.<pUnique> templates <pTemplates>
    * lowerCaseTemplate.<pUnique> single multi value <pSinti>
    * lowerCaseTemplate.<pUnique> path <pPath>
    * lowerCaseTemplate.<pUnique> file <pFile>
    * lowerCaseTemplate.<pUnique> var <pVar>
    * lowerCaseTemplate.<pUnique> vars <pVars>
    When lowerCaseTemplate.<pUnique> the values are passed into Cimerant
    Then lowerCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to lower case.
  @lowerCaseValue
  Scenario Outline: Value
    Given lowerCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then lowerCaseValue.<pUnique> Cimerant outputs <pOutputString>
