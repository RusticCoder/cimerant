Feature: Kebab Upper Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to kebab upper case.
  @kebabUpperCaseTemplate
  Scenario Outline: Template
    Given kebabUpperCaseTemplate.<pUnique> input file <pInputFile>
    * kebabUpperCaseTemplate.<pUnique> template <pTemplate>
    * kebabUpperCaseTemplate.<pUnique> templates <pTemplates>
    * kebabUpperCaseTemplate.<pUnique> single multi value <pSinti>
    * kebabUpperCaseTemplate.<pUnique> path <pPath>
    * kebabUpperCaseTemplate.<pUnique> file <pFile>
    * kebabUpperCaseTemplate.<pUnique> var <pVar>
    * kebabUpperCaseTemplate.<pUnique> vars <pVars>
    When kebabUpperCaseTemplate.<pUnique> the values are passed into Cimerant
    Then kebabUpperCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to kebab upper case.
  @kebabUpperCaseValue
  Scenario Outline: Value
    Given kebabUpperCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then kebabUpperCaseValue.<pUnique> Cimerant outputs <pOutputString>
