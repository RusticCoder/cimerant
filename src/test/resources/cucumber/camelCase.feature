Feature: Camel Case
  ...
  # The user will be able to combine a Velocity template and a formatted file to transform the values to camel case.
  @camelCaseTemplate
  Scenario Outline: Template
    Given camelCaseTemplate.<pUnique> input file <pInputFile>
    * camelCaseTemplate.<pUnique> template <pTemplate>
    * camelCaseTemplate.<pUnique> templates <pTemplates>
    * camelCaseTemplate.<pUnique> single multi value <pSinti>
    * camelCaseTemplate.<pUnique> path <pPath>
    * camelCaseTemplate.<pUnique> file <pFile>
    * camelCaseTemplate.<pUnique> var <pVar>
    * camelCaseTemplate.<pUnique> vars <pVars>
    When camelCaseTemplate.<pUnique> the values are passed into Cimerant
    Then camelCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to camel case.
  @camelCaseValue
  Scenario Outline: Value
    Given camelCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then camelCaseValue.<pUnique> Cimerant outputs <pOutputString>
