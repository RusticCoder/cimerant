Feature: Forward Slash Title Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to forward slash title case.
  @forwardSlashTitleCaseTemplate
  Scenario Outline: Template
    Given forwardSlashTitleCaseTemplate.<pUnique> input file <pInputFile>
    * forwardSlashTitleCaseTemplate.<pUnique> template <pTemplate>
    * forwardSlashTitleCaseTemplate.<pUnique> templates <pTemplates>
    * forwardSlashTitleCaseTemplate.<pUnique> single multi value <pSinti>
    * forwardSlashTitleCaseTemplate.<pUnique> path <pPath>
    * forwardSlashTitleCaseTemplate.<pUnique> file <pFile>
    * forwardSlashTitleCaseTemplate.<pUnique> var <pVar>
    * forwardSlashTitleCaseTemplate.<pUnique> vars <pVars>
    When forwardSlashTitleCaseTemplate.<pUnique> the values are passed into Cimerant
    Then forwardSlashTitleCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to forward slash title case.
  @forwardSlashTitleCaseValue
  Scenario Outline: Value
    Given forwardSlashTitleCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then forwardSlashTitleCaseValue.<pUnique> Cimerant outputs <pOutputString>
