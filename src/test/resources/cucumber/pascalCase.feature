Feature: Pascal Case
  ...
  # The user will be able to combine a Velocity template and a formatted file to transform the values to pascal case.
  @pascalCaseTemplate
  Scenario Outline: Template
    Given pascalCaseTemplate.<pUnique> input file <pInputFile>
    * pascalCaseTemplate.<pUnique> template <pTemplate>
    * pascalCaseTemplate.<pUnique> templates <pTemplates>
    * pascalCaseTemplate.<pUnique> single multi value <pSinti>
    * pascalCaseTemplate.<pUnique> path <pPath>
    * pascalCaseTemplate.<pUnique> file <pFile>
    * pascalCaseTemplate.<pUnique> var <pVar>
    * pascalCaseTemplate.<pUnique> vars <pVars>
    When pascalCaseTemplate.<pUnique> the values are passed into Cimerant
    Then pascalCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to pascal case.
  @pascalCaseValue
  Scenario Outline: Value
    Given pascalCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then pascalCaseValue.<pUnique> Cimerant outputs <pOutputString>

    Examples:
      | pUnique | pInputString      | pOutputString   |
      | 1       | null              | ""              |
      | 2       | ""                | ""              |
      | 3       | "a test string"   | "ATestString"   |
      | 4       | "a Test String"   | "ATestString"   |
      | 5       | "A test string"   | "ATestString"   |
      | 6       | "A Test String"   | "ATestString"   |
      | 7       | "A TEST STRING"   | "ATestString"   |
      | 8       | "a_test_string"   | "ATestString"   |
      | 9       | "a_Test_String"   | "ATestString"   |
      | 10      | "A_test_string"   | "ATestString"   |
      | 11      | "A_Test_String"   | "ATestString"   |
      | 12      | "A_TEST_STRING"   | "ATestString"   |
      | 13      | "a-test-string"   | "ATestString"   |
      | 14      | "a-Test-String"   | "ATestString"   |
      | 15      | "A-test-string"   | "ATestString"   |
      | 16      | "A-Test-String"   | "ATestString"   |
      | 17      | "A-TEST-STRING"   | "ATestString"   |
      | 18      | "a.test.string"   | "ATestString"   |
      | 19      | "a.Test.String"   | "ATestString"   |
      | 20      | "A.test.string"   | "ATestString"   |
      | 21      | "A.Test.String"   | "ATestString"   |
      | 22      | "A.TEST.STRING"   | "ATestString"   |
      | 23      | "a_test_string"   | "ATestString"   |
      | 24      | "a_Test_String"   | "ATestString"   |
      | 25      | "A_test_string"   | "ATestString"   |
      | 26      | "A_Test_String"   | "ATestString"   |
      | 27      | "A_TEST_STRING"   | "ATestString"   |
      | 28      | "a/test/string"   | "ATestString"   |
      | 29      | "a/Test/String"   | "ATestString"   |
      | 30      | "A/test/string"   | "ATestString"   |
      | 31      | "A/Test/String"   | "ATestString"   |
      | 32      | "A/TEST/STRING"   | "ATestString"   |
      | 33      | "a\\test\\string" | "ATestString"   |
      | 34      | "a\\Test\\String" | "ATestString"   |
      | 35      | "A\\test\\string" | "ATestString"   |
      | 36      | "A\\Test\\String" | "ATestString"   |
      | 37      | "A\\TEST\\STRING" | "ATestString"   |
