Feature: Snake Upper Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to snake upper case.
  @snakeUpperCaseTemplate
  Scenario Outline: Template
    Given snakeUpperCaseTemplate.<pUnique> input file <pInputFile>
    * snakeUpperCaseTemplate.<pUnique> template <pTemplate>
    * snakeUpperCaseTemplate.<pUnique> templates <pTemplates>
    * snakeUpperCaseTemplate.<pUnique> single multi value <pSinti>
    * snakeUpperCaseTemplate.<pUnique> path <pPath>
    * snakeUpperCaseTemplate.<pUnique> file <pFile>
    * snakeUpperCaseTemplate.<pUnique> var <pVar>
    * snakeUpperCaseTemplate.<pUnique> vars <pVars>
    When snakeUpperCaseTemplate.<pUnique> the values are passed into Cimerant
    Then snakeUpperCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to snake upper case.
  @snakeUpperCaseValue
  Scenario Outline: Value
    Given snakeUpperCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then snakeUpperCaseValue.<pUnique> Cimerant outputs <pOutputString>

    Examples:
      | pUnique | pInputString      | pOutputString   |
      | 1       | null              | ""              |
      | 2       | ""                | ""              |
      | 3       | "a test string"   | "A_TEST_STRING" |
      | 4       | "a Test String"   | "A_TEST_STRING" |
      | 5       | "A test string"   | "A_TEST_STRING" |
      | 6       | "A Test String"   | "A_TEST_STRING" |
      | 7       | "A TEST STRING"   | "A_TEST_STRING" |
      ...
      | 13      | "a-test-string"   | "A_TEST_STRING" |
      | 14      | "a-Test-String"   | "A_TEST_STRING" |
      | 15      | "A-test-string"   | "A_TEST_STRING" |
      | 16      | "A-Test-String"   | "A_TEST_STRING" |
      | 17      | "A-TEST-STRING"   | "A_TEST_STRING" |
      | 18      | "a.test.string"   | "A_TEST_STRING" |
      | 19      | "a.Test.String"   | "A_TEST_STRING" |
      | 20      | "A.test.string"   | "A_TEST_STRING" |
      | 21      | "A.Test.String"   | "A_TEST_STRING" |
      | 22      | "A.TEST.STRING"   | "A_TEST_STRING" |
      ...
      | 28      | "a/test/string"   | "A_TEST_STRING" |
      | 29      | "a/Test/String"   | "A_TEST_STRING" |
      | 30      | "A/test/string"   | "A_TEST_STRING" |
      | 31      | "A/Test/String"   | "A_TEST_STRING" |
      | 32      | "A/TEST/STRING"   | "A_TEST_STRING" |
      | 33      | "a\\test\\string" | "A_TEST_STRING" |
      | 34      | "a\\Test\\String" | "A_TEST_STRING" |
      | 35      | "A\\test\\string" | "A_TEST_STRING" |
      | 36      | "A\\Test\\String" | "A_TEST_STRING" |
      | 37      | "A\\TEST\\STRING" | "A_TEST_STRING" |
      ...
      | 43      | "aTestString"     | "A_TEST_STRING" |
      | 44      | "ATestString"     | "A_TEST_STRING" |
