Feature: Back Slash Upper Case

  # The user will be able to combine a Velocity template and a formatted file to transform the values to back slash upper case.
  @backSlashUpperCaseTemplate
  Scenario Outline: Template
    Given backSlashUpperCaseTemplate.<pUnique> input file <pInputFile>
    * backSlashUpperCaseTemplate.<pUnique> template <pTemplate>
    * backSlashUpperCaseTemplate.<pUnique> templates <pTemplates>
    * backSlashUpperCaseTemplate.<pUnique> single multi value <pSinti>
    * backSlashUpperCaseTemplate.<pUnique> path <pPath>
    * backSlashUpperCaseTemplate.<pUnique> file <pFile>
    * backSlashUpperCaseTemplate.<pUnique> var <pVar>
    * backSlashUpperCaseTemplate.<pUnique> vars <pVars>
    When backSlashUpperCaseTemplate.<pUnique> the values are passed into Cimerant
    Then backSlashUpperCaseTemplate.<pUnique> values are converted according to the template
  ...
  # The user will be able to transform values to back slash upper case.
  @backSlashUpperCaseValue
  Scenario Outline: Value
    Given backSlashUpperCaseValue.<pUnique> the input <pInputString> is passed into Cimerant
    Then backSlashUpperCaseValue.<pUnique> Cimerant outputs <pOutputString>
