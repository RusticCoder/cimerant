...
public class BackSlashUpperCaseValue {
   ...
   * @see Given
   */
  @Given("backSlashUpperCaseValue.{int} the input null is passed into Cimerant")
  public void givenTheInputNullIsPassedIntoCimerant(final Integer argUnique) {
    this.outputString = this.contextRoot.backSlashUpperCase((String) null);
  }
   ...
   * @see Given
   */
  @Given("backSlashUpperCaseValue.{int} the input {string} is passed into Cimerant")
  public void givenTheInputStringIsPassedIntoCimerant(
      final Integer argUnique, final String argInputString) {
    this.outputString = this.contextRoot.backSlashUpperCase(argInputString);
  }
   ...
   * @see Then
   */
  @Then("backSlashUpperCaseValue.{int} Cimerant outputs {string}")
  public void thenCimerantOutputs(final Integer argUnique, final String argOutputString) {
    ...
    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.backSlashLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 2));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.backSlashTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 3));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.backSlashUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 4));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.camelCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 5));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.dotLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 6));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.dotTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 7));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.dotUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 8));

    result =
        this.contextRoot.backSlashUpperCase(
    ...
    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.kebabLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 12));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.kebabTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 13));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.kebabUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 14));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.lowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 15));

    // result =
    // this.contextRoot.backSlashUpperCase(this.contextRoot.lowerFirst(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 16));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.pascalCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 17));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.snakeLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 18));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.snakeTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 19));

    result =
        this.contextRoot.backSlashUpperCase(this.contextRoot.snakeUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 20));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.titleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 21));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.upperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 22));

    result = this.contextRoot.backSlashUpperCase(this.contextRoot.upperFirst(this.outputString));
   ...
   * @see Then
   */
  @Then("backSlashUpperCaseValue.{int} Cimerant outputs null")
