...
public class LowerFirstValue {
   ...
   * @see Given
   */
  @Given("lowerFirstValue.{int} the input null is passed into Cimerant")
  public void givenTheInputNullIsPassedIntoCimerant(final Integer argUnique) {
    this.outputString = this.contextRoot.lowerFirst((String) null);
  }
   ...
   * @see Given
   */
  @Given("lowerFirstValue.{int} the input {string} is passed into Cimerant")
  public void givenTheInputStringIsPassedIntoCimerant(
      final Integer argUnique, final String argInputString) {
    this.outputString = this.contextRoot.lowerFirst(argInputString);
  }
   ...
   * @see Then
   */
  @Then("lowerFirstValue.{int} Cimerant outputs {string}")
  public void thenCimerantOutputs(final Integer argUnique, final String argOutputString) {
    ...
    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.backSlashLowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 2));

    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.backSlashTitleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 3));

    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.backSlashUpperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 4));

    // result = this.contextRoot.lowerFirst(this.contextRoot.camelCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 5));

    // result = this.contextRoot.lowerFirst(this.contextRoot.dotLowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 6));

    // result = this.contextRoot.lowerFirst(this.contextRoot.dotTitleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 7));

    // result = this.contextRoot.lowerFirst(this.contextRoot.dotUpperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 8));

    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.forwardSlashLowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 9));

    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.forwardSlashTitleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 10));

    // result =
    // this.contextRoot.lowerFirst(this.contextRoot.forwardSlashUpperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 11));

    // result = this.contextRoot.lowerFirst(this.contextRoot.kebabLowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 12));

    // result = this.contextRoot.lowerFirst(this.contextRoot.kebabTitleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 13));

    // result = this.contextRoot.lowerFirst(this.contextRoot.kebabUpperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 14));

    // result = this.contextRoot.lowerFirst(this.contextRoot.lowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 15));

    result = this.contextRoot.lowerFirst(this.contextRoot.lowerFirst(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 16));

    // result = this.contextRoot.lowerFirst(this.contextRoot.pascalCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 17));

    // result = this.contextRoot.lowerFirst(this.contextRoot.snakeLowerCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 18));

    // result = this.contextRoot.lowerFirst(this.contextRoot.snakeTitleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 19));

    // result = this.contextRoot.lowerFirst(this.contextRoot.snakeUpperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 20));

    // result = this.contextRoot.lowerFirst(this.contextRoot.titleCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 21));

    // result = this.contextRoot.lowerFirst(this.contextRoot.upperCase(this.outputString));
    // Assertions.assertEquals(argOutputString, result, String.format("#%d", 22));

    result = this.contextRoot.lowerFirst(this.contextRoot.upperFirst(this.outputString));
   ...
   * @see Then
   */
  @Then("lowerFirstValue.{int} Cimerant outputs null")
