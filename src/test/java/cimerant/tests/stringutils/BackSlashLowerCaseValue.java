...
public class BackSlashLowerCaseValue {
   ...
   * @see Given
   */
  @Given("backSlashLowerCaseValue.{int} the input null is passed into Cimerant")
  public void givenTheInputNullIsPassedIntoCimerant(final Integer argUnique) {
    this.outputString = this.contextRoot.backSlashLowerCase((String) null);
  }
   ...
   * @see Given
   */
  @Given("backSlashLowerCaseValue.{int} the input {string} is passed into Cimerant")
  public void givenTheInputStringIsPassedIntoCimerant(
      final Integer argUnique, final String argInputString) {
    this.outputString = this.contextRoot.backSlashLowerCase(argInputString);
  }
   ...
   * @see Then
   */
  @Then("backSlashLowerCaseValue.{int} Cimerant outputs {string}")
  public void thenCimerantOutputs(final Integer argUnique, final String argOutputString) {
    ...
    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.backSlashLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 2));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.backSlashTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 3));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.backSlashUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 4));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.camelCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 5));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.dotLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 6));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.dotTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 7));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.dotUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 8));

    result =
        this.contextRoot.backSlashLowerCase(
            this.contextRoot.forwardSlashLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 9));

    result =
        this.contextRoot.backSlashLowerCase(
            this.contextRoot.forwardSlashTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 10));

    result =
        this.contextRoot.backSlashLowerCase(
            this.contextRoot.forwardSlashUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 11));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.kebabLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 12));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.kebabTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 13));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.kebabUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 14));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.lowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 15));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.lowerFirst(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 16));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.pascalCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 17));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.snakeLowerCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 18));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.snakeTitleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 19));

    result =
        this.contextRoot.backSlashLowerCase(this.contextRoot.snakeUpperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 20));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.titleCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 21));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.upperCase(this.outputString));
    Assertions.assertEquals(argOutputString, result, String.format("#%d", 22));

    result = this.contextRoot.backSlashLowerCase(this.contextRoot.upperFirst(this.outputString));
   ...
   * @see Then
   */
  @Then("backSlashLowerCaseValue.{int} Cimerant outputs null")
